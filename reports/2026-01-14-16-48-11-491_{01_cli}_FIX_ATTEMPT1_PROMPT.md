# Fix Attempt1 [PROMPT]
**Timestamp:** 2026-01-14-16-48-11-491
**Requirement:** 01_cli
...
- **Requirement:** reqs\01_cli.md
- **Test:** tests/failing/01_cli.py
...
```bash
C:\Users\Human\Desktop\prjx\sqlite2json\ai-coder\bin\uv.exe run --script ./ai-coder/scripts/test.py tests/failing/01_cli.py
```
...
- `tests/failing/01_cli.py` -- the test file for this requirement
